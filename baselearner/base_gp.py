# -*- coding: utf-8 -*-
"""
Gaussian Process regression을 기반으로한 리그레서
Created on Tue Jul 04 09:05:31 2022
...
class BaseGP():
    """
        Gaussian Process Base Learner
    """
    
    def __init__(self):        
        self.scaler = StandardScaler()
        #self.scaler = RobustScaler()
        # Kernel, alpha setting 
        self.learner = GaussianProcessRegressor(normalize_y=True) # parameter 세팅?
