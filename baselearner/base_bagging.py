# -*- coding: utf-8 -*-
"""
Decision tree를 기반으로 한 bagging regressor

Created on Tue Jun 28 08:54:58 2022
...
class BaseBagging():
    ...
    def __init__(self):        
        ...
        self.learner = BaggingRegressor(n_estimators=50, max_features=10) # parameter 세팅?
        
    def fit(self, x, Y):
        """
        Bagging Regressor를 fitting
