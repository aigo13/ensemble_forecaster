...
class BaseElasticNet():
    """
        ElasticNet Base Learner
    """
    
    def __init__(self):        
        #self.scaler = StandardScaler()
        self.scaler = RobustScaler()
        self.learner = ElasticNet(alpha=0.1, l1_ratio=0.5) # parameter 세팅?
        
    def fit(self, x, Y):
        """
        Elastic Net을 fitting
